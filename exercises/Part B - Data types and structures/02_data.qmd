...
First create a folder "data" in your project. Then download it from [here](https://javier.science/R/Contents/Material/common_datasets/dataset_boys.csv){target="_blank"} and add it to that folder (use Ctrl+S in the browser to download it).
...
dim(boys)
```
There are 748 cases on 9 variables. 

Select the first six cases
```{r}
boys[1:6, ]
```
and the last six cases
```{r}
boys[743:748, ]
```
or, more efficiently:
...
Download the file `example_csv.csv` from [here](https://javier.science/R/Contents/Material/common_datasets/dataset_boys.csv){target="_blank"} and add it to your data folder.
