...
8. **If you are done, try to upload your files to GitHub.**
...
If interested, try to set up git in your RStudio (https://docs.posit.co/ide/user/ide/guide/tools/version-control.html
